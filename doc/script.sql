...
secondBranch varchar(40),
comunicationBranch varchar(40),
comunicatonBranchName varchar(40),
...
spotFlag int(40),
citicNo varchar(40),
invoiceNature int(11),
invoiceHead varchar(40),
invoiceCondition varchar(40),
