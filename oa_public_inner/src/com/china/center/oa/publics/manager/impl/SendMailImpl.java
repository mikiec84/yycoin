...
public class SendMailImpl
{
     ...
     */
    public SendMailImpl(String smtpServer, String from, String displayName, String username,
     ...
     */
    public SendMailImpl(String smtpServer, String from, String displayName, String[] to,
        ...
        try
        {
            ...
            if ( !file.isEmpty())
            {
                ...
                while (efile.hasMoreElements())
                {
                    ...
                    mbp.setFileName("=?GBK?B?"+enc.encode((fds.getName()).getBytes())+"?="); // 得到文件名同样至入BodyPart
                    mp.addBodyPart(mbp);
                }
