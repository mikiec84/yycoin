...
<html>
<head>
<p:link title="导入发票转移明细" />
<script language="JavaScript" src="../js/common.js"></script>
<script language="JavaScript" src="../js/JCheck.js"></script>
<script language="javascript">
function addBean()
{
	submit('确定导入发票转移明细?', null, checkValue);
}
...
<p:body width="100%">
	...
	<p:subBody width="80%">
		...
		<p:table cells="1">
			<p:cell title="导入模板">
				<a target="_blank"
					href="../admin/down.do?method=downTemplateFileByName&fileName=batchTransferInvoiceinsTemplate.xls">下载发票转移模板</a>
			</p:cell>
		</p:table>
