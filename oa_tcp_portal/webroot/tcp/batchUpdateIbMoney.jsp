...
<html>
<head>
    <p:link title="批量修改中收激励金额" />
    <script language="JavaScript" src="../js/common.js"></script>
    <script language="JavaScript" src="../js/JCheck.js"></script>
    <script language="javascript">
        function addBean()
        {
            submit('确定批量修改中收激励金额?', null, checkValue);
        }
    ...
    <p:body width="100%">
        ...
        <p:subBody width="80%">
            ...
            <p:table cells="1">
                <p:cell title="导入模板">
                    <a target="_blank"
                       href="../admin/down.do?method=downTemplateFileByName&fileName=batchUpdateIbMoneyTemplate.xls">下载批量修改中收激励金额模板</a>
                </p:cell>
            </p:table>
